module github.com/B777B2056-2/kugelblitz/cmd/kugelblitz-ui

go 1.24

require (
	github.com/B777B2056-2/kugelblitz v0.0.0
	github.com/B777B2056-2/kugelblitz/cmd/common v0.0.0
...
replace (
	github.com/B777B2056-2/kugelblitz => ../../
	github.com/B777B2056-2/kugelblitz/cmd/common => ../common
)
